...
for (let i = 0; i < starWarsCharacters.length; i++) {
  charactersNames = charactersNames + starWarsCharacters[i].name + " "
}
console.log("STARWARSCHARACTERNAME", charactersNames)
...
*/
let crewMass = 0
const mass = [277, 75, 32, 49, 75, 32, 84, 77]
let i = 0
...
console.log("MESSAGE ALERT", crewMass)
